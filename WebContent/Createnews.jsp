...
<div id="body">
    ...
    <div id="container">
        	...
        	<div class="sidebar">
            	<a class="btn_create" href="#">发布新闻</a>
               
<dl class="company_center_aside">
		<dt><a href="news.jsp">已发布的新闻</a></dt>
			<dd>&nbsp;</dd>
	</dl></div><!-- end .sidebar -->
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                      <form action="Servlet/NewsServlet?method=addNews" method="post">
                            ...
                            <table class="btm">
                            	...
                            	<tr>
                                	...
                                	<td width="85">新闻标题</td>
                                	<td>
                                    	<input type="text" placeholder="请输入招聘的主要信息" value="" name="title" id="title">
                                  </td>
                                </tr>
                            	<tr>
                                	<td></td>
                                	<td>发布单位</td>
                                	<td>
                                    	<input type="text" placeholder="请输入所属部门或公司" value="" name="company" id="company">	
                                    </td>
                                </tr>
                            </tbody></table>
                        ...
                        <table class="btm">
                            	...
                            	<tr>
                                	...
                                	<td>
                                   	...
                                   	<textarea name="detail" id="detail"></textarea></td>
                                </tr>
                          </tbody></table>
                          ...
                          <table>
                                ...
                                <tr>
                                	<td width="25"></td>
                                	<td colspan="2"><input type="submit" value="发布" class="btn_32">
                                    </td>
                                </tr>
                       	  </tbody></table>
                      </form>
