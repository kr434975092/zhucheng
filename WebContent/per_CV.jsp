...
<%
      ...
      List<CV>cvs = (List<CV>)session.getAttribute("per_CV");
      List<Job>jobs = (List<Job>)session.getAttribute("per_Jobs");
%>
<body>
<div id="body">
	<div id="header">
    ...
    <div id="container">
  		...
  		<div class="clearfix">
            <div class="content_l">
           	  ...
           	  <div class="profile_box" id="basicInfo">
           		  <h2>提交的职位</h2><form id="searchForm">
			                	...
			                	%>
				                			                            	<li>
		                                    <h3>
		                                        <a target="_blank" title="工作名" href="Job2.jsp?id=<%=jobs.get(i).getId()%>"><%=jobs.get(i).getJob() %></a> 
		                                        <span>[<%=jobs.get(i).getCity() %>]</span>
		                                        						                        		                                    </h3>
		                                    		                                  	
		                                  			                                    <div><%=jobs.get(i).getAttribute() %> / <%=jobs.get(i).getSalary() %> / <%=jobs.get(i).getExperience() %> / <%=jobs.get(i).getEdu() %></div>
		                                        ...
		                                        %>                   
		                                        <a class="job_del" href="Servlet/SUServlet?method=perCV_del&CVid=<%=cvs.get(i).getId()%>">删除</a>
		                                    </div>
		                                    		                                </li><%} %>
	                                	                           	</ul>
			                    			                </form>
            		...
            		</div><!--end .basicEdit--><!--end #basicInfo--><!--end #expectJob--><!--end #workExperience--><!--end #projectExperience--><!--end #educationalBackground--><!--end #selfDescription--><!--end #worksShow-->
          ...
          <div class="content_r">
           	<div class="mycenterR" id="myInfo">
            		<h2>我的信息</h2>
            		<a target="_blank" href="per_CV.jsp">我提交的职位</a>
            		<br>
