...
<div id="body">
    ...
    <div id="container">
		...
		<dt><a href="DownCV.jsp">我收到的简历</a></dt>
		<dd>&nbsp;</dd>
</dl>
<dl class="company_center_aside">
            	...
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	<div class="ccc_tr">今日已发布 <span>0</span> 个职位   还可发布 <span>5</span> 个职位</div>
                   	  <form action="Servlet/SServlet?method=addjob" method="post" id="jobForm">
                            <input type="hidden" value="" name="id">
                            <input type="hidden" value="create" name="preview">
                            <input type="hidden" value="<%=hunter.getName() %>" name="companyName">
