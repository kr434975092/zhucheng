...
<title>发布新职位-招聘服务-助成网-最专业的互联网招聘平台</title>
            	...
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	<div class="ccc_tr">今日已发布 <span>0</span> 个职位   还可发布 <span>5</span> 个职位</div>
                   	  <form action="Servlet/SServlet?method=updatejob" method="post" id="jobForm">
                            <input type="hidden" value="<%=request.getParameter("jobid") %>" name="jobid">
                            <input type="hidden" value="create" name="preview">
                            <input type="hidden" value="<%=request.getParameter("company") %>" name="CompanyName">
                            ...
                            <table class="btm">
                                ...
                                <tr>
                                	...
                                	<td>
                                    	<div class="salary_range">
                                            <div>
                                                <input type="text" placeholder="最少人数" value="" id="numberMin" name="numberMin"> 
                                                <span>人</span></div>
                                            <div>
                                                <input type="text" placeholder="最多人数" value="" id="numberMax" name="numberMax"> 
                                                <span>人</span>
                                            </div>
                                            <span>只能输入整数，如：9</span>
                                        </div>
                        ...
                        <table class="btm">
                            	...
                            	<tr>
                                	...
                                	<td>
                                    	<span class="c9 f14">(建议分条描述工作职责等。请勿输入公司邮箱、联系电话及其他外链，否则将自动删除)</span>
                                   	    <label for="miaoshu"></label>
                                   	<textarea name="miaoshu" id="miaoshu"></textarea></td>
                                </tr>
                                <tr>
                                	<td><span class="redstar">*</span></td>
                                	<td>工作地址</td>
                          ...
                          <table>
                           	  <tbody><tr>
                               	  <td width="25"><span class="redstar">*</span></td>
                               	  <td colspan="2">
                                   	  接收简历邮箱： <span id="receiveEmailVal">434975092@qq.com</span>
                                ...
                                <tr>
                                	<td width="25"></td>
                                	<td colspan="2"><input type="submit" value="发布" id="formSubmit" class="btn_32">
                                    </td>
                                </tr>
                       	  </tbody></table>
                      </form>
