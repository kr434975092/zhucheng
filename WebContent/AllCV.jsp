...
<%
	...
	List<CV>list = ControlDao.getCVs(company);
	int len = list.size();
%>
<div id="body">
	<div id="header">
    ...
    <div id="container">
		...
		<dt><a href="AllCV.jsp?company=<%=company %>">我收到的简历</a></dt>
		<dd>&nbsp;</dd>
</dl>
<dl class="company_center_aside">
            	...
            	<dl class="company_center_content">
                    ...
                    <dd>
			                	...
			                	%>
		                                    ...
		                                    <h3>
		                                        <a title="职位名称" href="Job2.jsp?company=<%=list.get(i).getCompany() %>&job=<%=list.get(i).getJob()%>"><%=list.get(i).getJob() %></a> 
		                                       
		                                        						                        		                                    </h3>
		                                    		                                  		<span class="receivedResumeNo"><a href="<%=list.get(i).getUrl() %>" target="_blank">下载简历</a></span>
                               			                                      <div><%=list.get(i).getName() %> /<%=list.get(i).getPhone() %></div>
		                                    		                                 
			                                    		                                    		                                    		                                    <div class="links">
		                                    			                                       
		                                       			                                       	<a target="_blank" class="job_edit" href=""></a>
		                                                             
		                                        <a href="Servlet/SUServlet?CVid=<%=list.get(i).getId()%>&method=deleteCv">删除</a>
		                                    </div>
