...
<%
	...
	Job job = ControlDao.search(id);
	List<CV>list = ControlDao.cvs(job);
	int len = list.size();
%>
<div id="body">
	<div id="header">
            	...
            	<dl class="company_center_content">
                    ...
                    <dd>
			                	...
			                	%>
		                                    ...
		                                    <h3>
		                                        <a title="职位名称" href="#"><%=job.getJob() %></a> 
		                                       
		                                        						                        		                                    </h3>
		                                    		                                  		<span class="receivedResumeNo"><a href="<%=list.get(i).getUrl() %>">下载简历</a></span>
