...
<%
    ...
    if(str_id!=null){
    	...
    	job = ControlDao.search(id);
    }else{
    	String company = request.getParameter("company");
    	String jobname = request.getParameter("job");
    	job = ControlDao.getJob(company, jobname);
    }
%>
<title><%=job.getJob() %>-<%=job.getCity() %>-助成招聘-最专业的互联网招聘平台</title>
    	...
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a href="campus.jsp">校园招聘</a></li>
    				    			<li>
	    				<a rel="nofollow" href="<%=request.getContextPath() %>/Servlet/SServlet?method=person">我的</a>
   			  </li>
            	...
            	<li><a href="<%=url2 %>" rel="nofollow"><%=tag2 %></a></li>
                                	...
                                	<dd style="display: none;"><a href="#">我发布的职位</a></dd>
                	<dd style="display: none;"><a href="#">我收到的简历</a></dd>
                	<dd class="btm" style="display: none;"><a href="#">我的公司主页</a></dd>
                	<dd style="display: none;"><a href="CompanyList.jsp">我要找工作</a></dd>
                                                <dd style="display: none;"><a href="#">帐号设置</a></dd>
    ...
    <div id="container">
            ...
            <div class="content_l">
                    ...
                    <dt>
                      <h1 title="<%=job.getJob() %>">
                            <em></em>
                                                        	<div><%=job.getCity() %>招聘</div>
                           	                           	<%=job.getJob() %>
                        </h1>
                    </dt>
                    <dd class="job_request">
                    	<span class="red">8k-15k</span>
                       	<span><%=job.getCity() %></span> 
                       	<span><%=job.getExperience() %> </span>
                       	<span><%=job.getEdu() %></span><br>
                      	 <%=job.getAdvantage() %>
                      	<div>发布时间：1天前发布</div>
                    </dd>
                    <dd class="job_bt">
                        <h3 class="description">职位描述</h3>
                        <p><strong>工作职责：</strong>&nbsp;<br><%=job.getDuty() %><br>&nbsp; <br> <strong>任职要求：</strong> <br>1、本科及以上学历，英语四级以上，专业不限；&nbsp; <br>2、对互联网产品有敏锐的直觉和良好的市场分析能力；&nbsp; <br>3、有严密的逻辑分析能力，有良好的沟通协作能力；&nbsp; <br>4、有很强的责任心、学习能力、文字表达能力；&nbsp; <br>5、具有很强的团队协助精神，善于总结和分享经验；&nbsp; <br>6、具有互联网产品规划和产品设计经验者优先。</p> 
<p>&nbsp;</p> 
...
<p>3、每周定期举办足球、羽毛球、篮球及员工深度互动等文体活动。</p>
					                    ...
					                    <dd>
                                        	                    				                   		<!-- 用户是否激活 0-否；1-是 -->
		                				                   			                                                                                             <%   if(hunter!=null&&hunter.getType()!=1&&hunter.getType()!=2){ %>
	                   					                        									                							                   		<form name="form1" enctype="multipart/form-data" method="post" action="Servlet/SUServlet?method=addCv&seekId=<%=hunter.getId()%>&jobId=<%=job.getId() %>" method="post">
	                   					                        									                							                   		  <p>
	                   					                        									                							                   		    <input type="hidden" name="seekname" value="<%=hunter.getName()%>"/>
	                   					                        									                							                   		    <input type="hidden" name="seekphone" value="<%=hunter.getPhone()%>"/>
	                   					                        									                							                   		    <input type="hidden" name="companyName" value="<%=job.getCompany()%>"/>
	                   					                        									                							                   		    <input type="hidden" name="jobName" value="<%=job.getJob()%>"/>
	                   					                        									                							                   		    <%
                   					                        									                							                   		      ...
                   					                        									                							                   		      <%
                   					                        									                							                   		           System.out.println(hunter.getName()+" "+hunter.getPhone()+" "+job.getCompany()+" "+job.getJob());
                   					                        									                							                   		         
                   					                        									                							                   		      %>
	                   					                        									                							                   		  <p>
	                   					                        									                							                   		    <input name="tijiao" type="submit" class="btn_small" id="tijiao" value="投个简历">
                   					                        									                							                   		      </p>
	                   					                        									                							                   		  <p>&nbsp;</p>
	                   					                        									                							                   		  <p>&nbsp; </p>
                                                                                                                                                                    </form><%} %>
                ...
                <dl class="job_company">
                    <dt>
                    	<a target="_blank" href="h/c/5004.html">
                            <img width="80" height="80" alt="" src="style/images/ff8080814356e881014357741e5910f1.jpg" class="b2">
                            <div>
                                <h2 class="fl">
                                	                                  		<%=job.getCompany() %>
                                    	<span class="dn">助成认证企业</span>
            		...
            		<ul class="reset">
            			            			<li>
            				<a target="_blank" href="CompanyList.jsp">
								<span class="f14">产品经理</span>
								<span class="c7">短讯神州</span></a>
            			</li>
            			            			<li>
            				<a target="_blank" href="CompanyList.jsp">
								<span class="f14">产品经理</span>
								<span class="c7">爱拍</span></a>
            			</li>
            			            			<li>
            				<a target="_blank" href="CompanyList.jsp">
								<span class="f14">产品经理</span>
								<span class="c7">一彩票</span></a>
            			</li>
            			            			<li>
            				<a target="_blank" href="CompanyList.jsp">
								<span class="f14">产品经理</span>
								<span class="c7">林安集团</span></a>
            			</li>
            			            			<li>
            				<a target="_blank" href="CompanyList.jsp">
								<span class="f14">产品经理</span>
								<span class="c7">鼎梵数码科技</span></a>
            			</li>
   			            		  </ul>
            		            		<a target="_blank" class="more" href="CompanyList.jsp">更多推荐职位&gt;&gt;</a>
	            	  </div><!--end #myRecommend-->
				                <a class="eventAd" target="_blank" href="CompanyList.jsp">
...
<!-- 投递简历时  - 设置默认投递简历 -->
	...
	<div style="height:240px;" class="popup" id="loginPop">
		...
		<div class="login_right">
			<div>还没有助成帐号？</div>
			<a class="registor_now" href="Register1.jsp">立即注册</a>
    ...
    <div class="popup" id="deliverResumesNo">
        <table width="100%">
            <tbody><tr>
                <td align="center"><p class="font_16">你在助成还没有简历，请先上传一份</p></td>
            </tr>
        	<tr>
            	<td align="center">
                    <form>
