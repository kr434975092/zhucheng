...
<%
      ...
      News news = ControlDao.read(id);
%>
<title>-助成招聘-最专业的互联网招聘平台</title>
    	...
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
            	...
            	<li><a href="<%=url2 %>" rel="nofollow"><%=tag2 %></a></li>
                                	...
                                	<dd style="display: none;"><a href="#">已发布的新闻</a></dd>
...
<!--                                                 <dd style="display: none;"><a href="accountBind.html">帐号设置</a></dd> -->
    ...
    <div id="container">
            ...
            <div class="content_l">
            	                <dl class="job_detail">
                    <dt>
                      <h1 title="<%=news.getTitle() %>">
                            <em></em>
                       	<div><%=news.getCompany() %></div>
                           	   <%=news.getTitle() %> 
                      </h1>
                    </dt>
                    <dd class="job_request">
                         <div>发布时间:<%=news.getTime() %></div>
                    </dd>
                    <dd class="job_bt">
                    <h3 class="description">职位描述</h3>
                        <p><strong>工作职责：</strong>&nbsp;<br><%=news.getDetail() %><br>&nbsp; <br>
<p>&nbsp;</p> 
            ...
            <div class="content_r">
                <dl class="job_company">
            		...
            		<ul class="reset">
            			            			<li>
            				<a href="campus.jsp">
								<span class="f14">铁大春招</span>
								<span class="c7">铁大</span></a>
            			</li>
            			            			<li>
            				<a href="campus.jsp">
								<span class="f14">铁大校招</span>
								<span class="c7">铁大</span></a>
            			</li>
            			            			<li>
            				<a href="campus.jsp">
								...
								<span class="c7">林安集团</span></a>
            			            			...
            			            			<li>
            				<a href="campus.jsp">
								<span class="f14">校园招聘</span>
								<span class="c7">鼎梵数码科技</span></a>
            			</li>
   			            		  </ul>
            		            		<a class="more" href="campus.jsp">更多资讯&gt;&gt;</a>
	            	  </div><!--end #myRecommend-->
				                <a class="eventAd" href="CompanyList.jsp">
	    	...
	    	<tr>
	        	<td>
                    <form class="resumeSetForm" id="resumeSetForm">
	            		...
	            		<div class="setBtns">
	            				            				<a class="downloadResume dn" href="#">下载</a> <span class="dn">|</span>
            					<a class="reUpload" title="上传附件简历">上传附件简历</a>
...
<!-- 投递简历时  - 设置默认投递简历 -->
	...
	<div style="height:240px;" class="popup" id="loginPop">
		...
		<div class="login_right">
		    ...
		    <a title="使用新浪微博帐号登录" class="icon_wb" href="#"></a>
		    <a title="使用腾讯QQ帐号登录" class="icon_qq" href="#"></a>
		</div>
    </div><!--/#loginPop-->
    ...
    <div class="popup" id="fileResumeUpload">
        <table width="100%">
        	...
        	<tr>
            	<td align="center">
            		<a title="上传附件简历" href="#" class="inline btn cboxElement">重新上传</a>
            	</td>
            </tr>
        </tbody></table>
        ...
        <table width="100%">
            <tbody><tr class="drawGGJ">
                <td align="center">
                	...
                	<p class="font_16 share dn">邀请好友成功注册拉勾，可提升每日投递量 &nbsp;&nbsp; <a href="#">邀请好友&gt;&gt;</a></p>
                </td>
            </tr>
        	<tr class="drawQD">
            	<td align="center"><a class="btn_s" href="javascript:top.location.reload();">确&nbsp;定</a></td>
	...
	<div style="height:240px;" class="popup" id="activePop">
       	...
       	<p>我们已将验证邮件发送至：<a>jason@qq.com</a>，请点击邮件内的链接完成验证。</p>
                <p><a id="resend" href="javascript:void(0)">重新发送验证邮件 </a> | <a href="#"> 换个邮箱？ </a>  	</p>
    </div><!--/#activePop-->    
